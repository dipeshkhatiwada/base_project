                ...
                <form method="POST" action="{{ route('role.update',$role->id) }}">
                    ...
                    <div class="block mt-4">
                        <label for="status" class="inline-flex items-center">
                            ...
                            <input id="status" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="status" {{ $role->status ? 'checked' : ''}} value="1">
